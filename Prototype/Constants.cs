namespace Prototype
{
    internal static class Constants
    {
        ...
        internal const string TestText =
            ...
            "putate velit esse molestie consequat, vel illum dolore eu feugiat nulla f" +
            "acilisis at vero eros et accumsan et iusto odio dignissim qui blandit pra" +
            "esent luptatum zzril delenit augue duis dolore te feugait nulla facilisi." +
            ...
            "  \r\n\r\nUt wisi enim ad minim veniam, quis nostrud exerci tation ullamc" +
            "orper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis aut" +
            "em vel eum iriure dolor in hendrerit in vulputate velit esse molestie con" +
            "sequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accum" +
            "san et iusto odio dignissim qui blandit praesent luptatum zzril delenit a" +
            "ugue duis dolore te feugait nulla facilisi.   \r\n\r\nNam liber tempor cu" +
            "m soluta nobis eleifend option congue nihil imperdiet doming id quod mazi" +
            "m placerat facer possim assum. Lorem ipsum dolor sit amet, consectetuer a" +
            ...
            "um. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum do" +
            "lor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, se" +
            "d diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam e" +
            "rat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea" +
            " rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsu" +
            "m dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr" +
            ", At accusam aliquyam diam diam dolore dolores duo eirmod eos erat, et no" +
